...
public class ListCheapProductHomeSellerAdapter extends RecyclerView.Adapter<ListCheapProductHomeSellerAdapter.ListViewHolder> {
    ...
    public ListCheapProductHomeSellerAdapter(ArrayList<Product> list) {
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_row_cheapest_seller, parent, false);
    ...
    public void onBindViewHolder(@NonNull ListViewHolder holder, int position) {
        ...
        holder.textView_available.setText("Stock: " + product.getAvailable());
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ListViewHolder(@NonNull View itemView) {
            super(itemView);
            imageButton_image = itemView.findViewById(R.id.imageButton_cheapest_seller);
            textView_number = itemView.findViewById(R.id.textView_counter_item_cheapest_seller);
            textView_productName = itemView.findViewById(R.id.textView_product_name_cheapest_seller);
            textView_productPrice = itemView.findViewById(R.id.textView_product_price_cheapest_seller);
            textView_available = itemView.findViewById(R.id.textView_available_cheapest_seller);
            textView_status = itemView.findViewById(R.id.textView_status_product_cheapest_seller);
        }
    }
}
